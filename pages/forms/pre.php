      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Pre-Sales Feedback</li>
          </ol>
        </section>
          ...
          <div class="row">
              ...
              <div class="box box-success">
				...
				<table style="width:70%" height="70%">
                      ...
                      <th width="10%" style="padding: 25px;">Execellent</th>
					  <th width="10%" style="padding: 25px;">Good</th>
					  <th style="padding: 25px;">Average</th>
					   <th style="padding: 25px;">Poor</th>
                       <tr>
                        <td>Making you feel comfortable</td>
                        <td>
						    <label>					   
                             <input type="radio" name="r3" class="flat-red" value="Execellent">
                             </label>
					    </td>		
                        <td>
						 <label>
					  ...
					  <tr>
                        <td>Making you confident that this was the right vehicle</td>
                        <td>
						    <label>					   
                             <input type="radio" name="r4" class="flat-red" value="Execellent">
                              </label>
					    </td>		
                        <td>
						 <label>
					  ...
					  <tr>
                        <td>Handling your purchase in a professional and timely manner</td>
                        <td>
						    <label>					   
                             <input type="radio" name="r5" class="flat-red" value="Execellent">
                              </label>
					    </td>		
                        <td>
						 <label>
					  ...
					  <tr>
                        <td>Working as a team to best satisfy you</td>
                        <td>
						    <label>					   
                             <input type="radio" name="r6" class="flat-red" value="Execellent">
                              </label>
					    </td>		
                        <td>
						 <label>
					  ...
					  <tr>
                        ...
                        <td>
						    <label>					   
                             <input type="radio" name="r7" class="flat-red" value="Execellent"> 
                              </label>
					    </td>		
                        <td>
						 <label>
					  ...
					  <tr>
                        <td>Time spent with you</td>
                        <td>
						    <label>					   
                             <input type="radio" name="r8" class="flat-red" value="Execellent">
                              </label>
					    </td>		
                        <td>
						 <label>
					  ...
					  <tr>
                        ...
                        <td>
						    <label>					   
                             <input type="radio" name="r9" class="flat-red" value="Execellent">
                              </label>
					    </td>		
                        <td>
						 <label>
					  ...
					  <tr>
                        ...
                        <td>
						    <label>					   
                             <input type="radio" name="r1" class="flat-red" value="Execellent">
                              </label>
					    </td>		
                        <td>
						 <label>
