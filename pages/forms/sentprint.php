...
<html>
  ...
  <?php
  $sql=mysql_query("SELECT * FROM `sent_email` WHERE `email_number`='".$_GET['print']."' ");
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-read-info">
                    ...
                    <h5>TO: <?php echo $row['to_emails']; ?> <span class="mailbox-read-time pull-right"><?php echo $row['created_at']; ?></span></h5>
                    <h5>CC: <?php echo $row['cc_emails']; ?></h5>
