    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<div class="box-header">
                    <button type="button" class="btn btn-primary" name="insert" onClick="location.href='delivery.php'"  value="Add Entry">Add Entry</button>
                  </div>
				  </form>
		  <br><br>
				...
				<table style="width:70%"  class="table table-striped">
					<tbody>
					  ...
					  <tr>
						...
						<div class="btn-group">
						<td> 
							<button type="button" class="btn btn-primary" onClick="location.href='deliveryedit.php?edi=<?php echo $row['enq_id']; ?>'">EDIT</a></button>
							</td>
							<td>
							<button type="button" class="btn btn-primary" onClick="location.href='deliverydelete.php?did=<?php echo $row['enq_id']; ?>'" >Delete</a></button>
                          </td>
                         </div>
                         </tr>
                         <?php } ?>
