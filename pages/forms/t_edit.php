		  ...
		  <div class="box box-info"><input type="hidden" name="edi" value="<?php echo $_GET['edi']; ?>">
                <!-- form start -->
                  <div class="box-body">
					...
					<div class="form-group">
                      <label for="enq">Customer_Id</label><input type="text" required value="<?php echo $row['Cus_id'];?>" style="width:70%" class="form-control input-sm" name="tcu">
                    </div>
                    <div class="form-group">
                      <label for="mail">Customer_Name</label><input type="text" required value="<?php echo $row['Cus_name'];?>" style="width:70%" class="form-control input-sm" name="tcun">
                    </div>
					<div class="form-group">
                      <label>Place of TD</label>
     		           <select class="form-control" style="width:70%" name="place" required>
                        ...
                        <option value='Customer place'<?php if('Customer place'==$row['place_td']){ ?>selected="selected"<?php } ?>>Customer place</option>
				   	  ...
				   	  <div class="form-group">
                     <label for="mail">Test Drive No.</label><input type="text" required value="<?php echo $row['td_no'];?>" style="width:70%" class="form-control input-sm" name="drn">
                  </div>
            <div class="form-group">
              <label>Date</label>
			    <div class="input-group date" data-provide="datepicker" style="width:70%">
                   <input type="text" class="form-control" name="test_date" value="<?php echo $row['date'];?>" required >
		    ...
		    <div class="form-group">
			 ...
			 <input type="text" style="width:70%" value="<?php echo $row['dur'];?>" class="form-control input-sm" name="dur" required>
            </div>
			</div>
