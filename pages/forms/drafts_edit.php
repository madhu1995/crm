...
if(isset($_GET['to']))
{
	$res1=mysql_query("SELECT * FROM `drafts` WHERE `email_number`='".$_GET['to']."'");
...
function onsubmitform()
{
  ...
  // alert("yes");
   if (document.getElementById("to").value == "" || document.getElementById("subject").value == "" || document.getElementById("compose-textarea").value == "") 
   {
	...
	alert("no");
   document.myform.action ="mail1.php?eid=<?php echo $_GET['to'];?>";
   return true;
   }
  }
  else if(document.pressed == 'drafts')
  {
   ...
   document.myform.action ="drafts1.php?did=<?php echo $_GET['to'];?>";
   return true;
  }
}
</script>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <input class="form-control" placeholder="To:" name="to" id="to"  value="<?php echo $rows['to_emails']; ?>">
                  </div>
				  <div class="form-group">
                    <input class="form-control" placeholder="Cc:" name="cc" id="cc" value="<?php echo $rows['cc_emails']; ?>">
                  </div>
                  <div class="form-group">
                    <input class="form-control" style="font-weight: bold;" id="subject" placeholder="Subject:" name="subject" value="Aadhi Maruti - " id="subject" value="<?php echo $rows['subject']; ?>">
                  </div>
                  <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px" name="content" >
					  <?php echo $rows['mail_body']; ?></textarea>
                  </div>
                  <div class="form-group">
