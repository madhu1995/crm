...
if(isset($_GET[edi]))
{
$sql=mysql_query("select * from ser_appmnt where service_no='".$_GET['edi']."' ");
...
$result=mysql_query(" UPDATE `ser_appmnt` SET `cust_name`='$cust_name',`phone`='$phone',`email`='$email',`amc_type`='$amc_type',`servicedate`='$servicedate',`car_regno`='$car_regno',`model`='$model',`fuel_type`='$fuel_type',`engine_no`='$engine_no',`modelyear`='$modelyear',`chassis_no`='$chassis_no',`milage`='$milage' WHERE service_no='".$_GET['edi']."'");
              ...
              <div class="box box-primary">
                ...
                <!-- form start enquiry-->
				  ...
				  <div class="form-group">
					  ...
					  <input type="text" required id="cu" style="width:70%" class="form-control input-sm" disabled="" name="cust_id" value="<?php echo $row['cust_id']; ?>" >
                    </div>
					...
					<div class="form-group">
                      <label>Email</label>
                      <input type="text" style="width:70%" class="form-control input-sm" name="email"  value="<?php echo $row['email']; ?>">
                    </div>
				 ...
				 <div class="form-group">
					  ...
					  <div class="form-group">
                       <label>Service Date</label>
					    <div class="input-group date"  style="width:70%" value="<?php echo $row['servicedate']; ?>">
                        <input type="text" class="form-control" id="s_dt" name="servicedate" value="<?php echo $row['servicedate']; ?>">
                ...
                <!-- form start -->
                  <div class="box-body">
					...
					<div class="form-group">
					  ...
					  <select class="form-control" style="width:70%" id="year" name="modelyear" value="<?php echo $row['modelyear']; ?>">
                          <script>
                              var myDate = new Date();
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
                      ...
                      <input type="text" style="width:70%" class="form-control input-sm" name="milage" placeholder="Enter kilometer" value="<?php echo $row['milage']; ?>">
                    </div>	
				  ...
				  <div class="box-footer">
                    <button type="submit" class="btn btn-primary" name="submit" id="suub" >Update</button>
                  </div><!-- /.box-footer -->
