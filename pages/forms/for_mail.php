...
$mail->addAttachment($_SERVER["DOCUMENT_ROOT"] . '/new1/pages/forms/attachments/'.$_POST['attach']);
print_r($_SERVER["DOCUMENT_ROOT"] .  '/new1/pages/forms/attachments/'.$_POST['attach']);
$mail->WordWrap = 50;
	if(!$mail->Send())
	{ 
	...
	{ 
	   copy('attachments/'.$_POST['attach'], 'sent mails/'.$_POST['attach']);
