...
if(isset($_GET['did']))
{
	$sql=mysql_query("delete from amc where amc_no='".$_GET['did']."' ");
}
		       ...
		       <div class="form-group">
					 ...
					 <!-- <button onclick="myFunction()">Try it</button> -->
                      ...
                      var x;
						 ...
						 location.href="amc_sd.php?gid=" + x;
                     }
                     </script>
					  <script>
                       function renvl() {
						 location.href="amc_renewal.php";
                     }
                     </script>
		       </div>
		        ...
		        <div class="col-md-6 ">
		         <div class="btn-group">
				    <td> 
				      <button type="button" class="btn btn-primary " name="amc" onClick="myFunction1()">AMC</a></button>
					</td>
				 </div>
				</div>
				 ...
				 <div class="col-md-6 pull-right">
				   <div class="btn-group">
				    <td> 
				      <button type="button" class="btn btn-primary " name="renw" onClick="renvl()">Renewal</a></button>
					</td>
                  </div>
				 </div>
				 </div>
					...
					<tbody>
					  ...
					  <th>Car no</th>
					   ...
					   <th>EndDate</th>
                        ...
                        <?php
						$query=mysql_query("select * from amc");
						...
						<div class="btn-group">
							...
							<button type="button" class="btn btn-primary" onClick="location.href='amc_delete.php?did=<?php echo $row['amc_no']; ?>'" ><i class="fa fa-trash-o"></i></button>
                            </td>
							<td>
