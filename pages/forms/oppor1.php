                ...
                <!-- form start enquiry-->
                  <div class="box-body">
                    ...
                    <div class="form-group">
					  ...
					  <input type="text"  required pattern="[a-zA-Z.\s ]+" title="Name must in alphabets"  id="cun" style="width:70%" class="form-control input-sm" name="cus_name" value="<?php echo $row['custname']; ?>">
                    </div>
					<div class="form-group">
