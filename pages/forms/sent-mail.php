...
if(isset($_GET['did']))
{
	$res1=mysql_query("SELECT * FROM `sent_email` WHERE `email_number`='".$_GET['did']."'");
    $rows=mysql_fetch_array($res1);
}
if(isset($_POST['delete']))
{
$query=mysql_query("DELETE FROM `sent_email` WHERE `email_number`='".$_GET['did']."'");
if($query)
{
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Read Sent Mails</h3>
                 </div><!-- /.box-header -->
                <div class="box-body no-padding">
                  ...
                  <div class="mailbox-controls with-border text-center">
                    <div class="btn-group">
                      ...
                      <a href="s_reply.php?to=<?php echo $rows['email_number']; ?>" class="btn btn-default btn-sm" data-toggle="tooltip" title="Reply"><i class="fa fa-reply"></i></a>
                      <a href="s_forward.php?fwd=<?php echo $rows['email_number']; ?>" class="btn btn-default btn-sm" data-toggle="tooltip" title="Forward"><i class="fa fa-share"></i></a>
                    </div><!-- /.btn-group -->
                    <a href="sentprint.php?print=<?php echo $_GET['did']; ?>" target="_blank" class="btn btn-default btn-sm" data-toggle="tooltip" title="Print"><i class="fa fa-print"></i></a>
