...
if(isset($_GET['to']))
{
	$res1=mysql_query("SELECT * FROM `emails` WHERE `email_number`='".$_GET['to']."'");
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <input class="form-control" placeholder="To:" id="to" name="to" readonly value="<?php echo $rows['from_email']; ?>">
                  </div>
				  <div class="form-group">
                    <input class="form-control" placeholder="Cc:" id="cc" name="cc">
                  </div>
                  <div class="form-group">
                    <input class="form-control" style="font-weight: bold;" id="subject" placeholder="Subject:" name="subject" value="Aadhi Maruti - " id="subject">
                  </div>
                  <div class="form-group">
