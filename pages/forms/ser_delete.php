...
if(isset($_GET['did']))
{
	$sql=mysql_query("delete from ser_detail where service_no='".$_GET['did']."' ");
	$sql1=mysql_query("delete from ser_events where title='".$_GET['did']."' ");
}
?>
		...
		<div class="form-group">
               ...
               <script>
                      ...
                      var x;
						 ...
						 location.href="service_sd.php?gid=" + x;
                     }
                </script>
		 </div>
		 <div class="btn-group">
				    <td> 
				      <button type="button" class="btn btn-primary" name="service" onClick="myFunction3()">Service_Detail</a></button>
					</td>	
				 </div>
					...
					<tbody>
					  ...
					  <th>Car no</th>
					   ...
					   <th>NextService</th>
						...
						<td>
							<button type="button" class="btn btn-primary" onClick="location.href='ser_delete.php?did=<?php echo $row['service_no']; ?>'" ><i class="fa fa-trash-o"></i></a></button>
						</td>
						<td>
							<button type="button" class="btn btn-primary" onClick="location.href='ser_edit.php?edi=<?php echo $row['service_no']; ?>'" ><i class="fa fa-pencil"></i></a></button>
						</td>
						</div>
