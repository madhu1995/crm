...
if(isset($_GET['to']))
{
	$res1=mysql_query("SELECT * FROM `sent_email` WHERE `email_number`='".$_GET['to']."'");
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <input class="form-control" placeholder="To:" name="to" id="to" readonly value="<?php echo $rows['to_emails']; ?>">
                  </div>
				  <div class="form-group">
