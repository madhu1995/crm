...
if(isset($_GET['did']))
{
	$sql=mysql_query("delete from ser_appmnt where service_no='".$_GET['did']."' ");
}
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">Service Appointments</li>
          </ol>
        </section>
		...
		<div class="form-group">
                      <label for="enq">Car_Regno</label>
					  <input type="text" required style="width:30%" class="form-control input-sm" name="car_regno" id="reg">
                    <script>
                       function myFunction2() {
                      var x;
                         x=  document.getElementById("reg").value;
						 location.href="appoin_sd.php?gid=" + x;
		...
		<div class="btn-group">
				    <td> 
				      <button type="button" class="btn btn-primary" name="appoin" onClick="myFunction2()">Appointments</a></button>
					</td>	
				 </div>
				<!--   <button type="button" class="btn btn-primary" name="insert" onClick="location.href='search.php'"  value="Add Entry">Add Entry</button>
                -->
	    </div>
	</form>
		<br><br>
				...
				<table style="width:70%"  class="table table-striped">
					<tbody>
					  ...
					  <th>Car no</th>
					   <th>Service no</th>
					  <th>AMC</th>
					   <th>Service Date date</th>
					   
					   
                       </tr>
                        <?php
						$query=mysql_query("select * from ser_appmnt");
						...
						<div class="btn-group">
							...
							<td>
							<button type="button" class="btn btn-primary" onClick="location.href='appdelete.php?did=<?php echo $row['service_no']; ?>'" ><i class="fa fa-trash-o"></i></a></button>
                            </td>
							<td>
							<button type="button" class="btn btn-primary" onClick="location.href='app_edit.php?edi=<?php echo $row['service_no']; ?>'" ><i class="fa fa-pencil"></i></a></button>
                            </td>
						</div>
