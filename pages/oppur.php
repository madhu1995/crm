...
$query=mysql_query("insert into vehicle(model,fuel,color,quant,status,Enq_id,Cust_id,Cust_name,app_date,pri_model) VALUES ('".$_POST['model2']."','".$_POST['fuel']."','".$_POST['color']."','".$_POST['quan']."','".$_POST['stat']."','".$_POST['en_id']."','".$_POST['cu_id']."','".$_POST['cu_name']."','".$_POST['ap_d']."','".$_POST['imp']."')");
                  ...
                  <div class="box-body">
					...
					<div class="form-group">
					 ...
					 <label>Test-Drive</label>
                      ...
                      <div class="radio" class="col-sm-14">
                        <label class="col-sm-3">
                          <input type="radio" onclick="Function()" name="t_d" value="Yes" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">
                          Yes
						</label>
						<label class="col-sm-6">
		...
		<form role="form" method="post">
          <div class="modal-header">
           ...
           <div class="modal-body">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default" name="mysub">Submit</button>
            </div>
			</form>
  </div>
 </div>
