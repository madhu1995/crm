...
if(isset($_GET['did']))
{
	$sql=mysql_query("delete from ser_app where Customer_id='".$_GET['did']."' ");
}
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<div class="box-header">
                    <button type="button" class="btn btn-primary" name="insert" onClick="location.href='servicedetails.php'"  value="Add Entry">Add Entry</button>
                  </div>
				  </form>
		<br><br>
					...
					<tbody>
					  ...
					  <!-- <th>Serviced_by</th> -->
					   ...
					   <!--<th>Next_service -->
                        ...
                        <?php
						$query=mysql_query("select * from ser_app");
						...
						<td><?php echo $row['Warenty_period']; ?></td>
						
						<td><?php echo $row['Service_Start_Date']; ?></td>
						
						<div class="btn-group">
						<td> 
							<button type="button" class="btn btn-primary" onClick="location.href='sdetailedit.php?edi=<?php echo $row['Customer_id']; ?>'">EDIT</a></button>
							</td>
							<td>
							<button type="button" class="btn btn-primary" onClick="location.href='appdelete.php?did=<?php echo $row['Customer_id']; ?>'" >Delete</a></button>
