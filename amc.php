...
{
$query=mysql_query("INSERT INTO amc(Customer_id, Customer_name, Service_no, AMC_type, Model, Fuel_type, Year_of_purchase, Kilometers_covered, Contract_startdate, Contract_enddate, No_of_year) VALUES ('".$_POST['cust_id']."','".$_POST['cust_name']."','".$_POST['ser_no']."', '".$_POST['amc']."', '".$_POST['model']."', '".$_POST['fuel']."','".$_POST['purch']."', '".$_POST['kilo_mtr']."','".$_POST['start_dt']."', '".$_POST['end_dt']."', '".$_POST['yr']."' )");
      ...
      <div class="content-wrapper">
		...
		<form role="form" method="post">
					...
					<div class="form-group">
                      ...
                      <input type="text" style="width:70%" class="form-control input-sm" name="cust_name" pattern="[a-zA-Z]+" placeholder="Enter name">
                    </div>
					...
					<div class="form-group">
		             ...
		             <div class="col-xs-3">
					  ...
					  <select class="form-control" style="width:70%" id="year" name="year">
                          <script>
                              var myDate = new Date();
					...
					<button type="button" class="btn btn-primary" name="delete" onClick="location.href='amcdelete.php'"  value="Delete">Delete</button>
                    </div> 
