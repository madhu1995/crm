...
if(isset($_GET['did']))
{
	$sql=mysql_query("delete from ser_detail where Customer_id='".$_GET['did']."' ");
}
					...
					<tbody>
					  ...
					  <!-- <th>Serviced_by</th> -->
					   ...
					   <!--<th>Next_service -->
						...
						<div class="btn-group">
						<td> 
							<button type="button" class="btn btn-primary" onClick="location.href='sdetailedit.php?edit=<?php echo $row['Customer_id']; ?>'">EDIT</a></button>
							</td>
							<td>
							<button type="button" class="btn btn-primary" onClick="location.href='serdelete.php?did=<?php echo $row['Customer_id']; ?>'" >Delete</a></button>
