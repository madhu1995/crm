                ...
                <!-- form start enquiry-->
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <label for="enq">Enquiry_Id</label><input type="text" id="enq" disabled="" style="width:70%" class="form-control input-sm" name="Enq_id" value="<?php echo $row['Enq_id'];?>">
                    </div>
					<div class="form-group">
                      <label for="enq">Customer_Id</label><input type="text" id="cu" style="width:70%" class="form-control input-sm" name="cus_id" value="<?php echo $row['Cus_id'];?>">
                    </div>
                    <div class="form-group">
                      <label for="mail">Customer_Name</label><input type="text" id="cun" style="width:70%" class="form-control input-sm" name="cus_name" value="<?php echo $row['Cus_name'];?>">
                    </div>
					<div class="form-group">
                      <label>Date of Enquiry</label>
					    <div class="input-group date" data-provide="datepicker" style="width:70%">
                          <input type="text" class="form-control" name="doe" value="<?php echo $row['DOE'];?>" >
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <input type="text" style="width:70%" value="<?php echo $row['Off_name'];?>" class="form-control input-sm" id="off-name1" name="off_name"  placeholder="Enter office name">
                    </div>
					<div class="form-group">
                      <label>Office Address</label>
                      <textarea class="form-control input-sm" style="width:70%" rows="3" placeholder="Enter ..." name="off_add"><?php echo $row['Off_addr'];?></textarea>
                    </div>
				    <div class="form-group">
                      <label for="phone">Phone</label>
                      <input type="text" style="width:70%" value="<?php echo $row['Off_ph1'];?>" class="form-control input-sm" id="off-phone1" name="off_ph1"  placeholder="Enter mobile number">
                    </div>
					<div class="form-group">
                      <label for="phone">Alternate Phone</label>
                      <input type="text" style="width:70%" value="<?php echo $row['Off_ph2'];?>" class="form-control input-sm" id="off-phone2" name="off_ph2" placeholder="Enter mobile number">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Email</label>
                      <input type="text" style="width:70%" value="<?php echo $row['Off_email'];?>" class="form-control input-sm" id="exampleInputEmail1" name="off_em" placeholder="Enter mail">
                    </div>
					<div class="form-group">
                      <label>City</label>
					...
					<div class="form-group">
                      ...
                      <input type="text" style="width:70%" value="<?php echo $row['Off_Pin'];?>" class="form-control input-sm" id="offpin1" name="off_pin"  placeholder="Enter pincode">
                    </div>
                </div><!-- /.box-body -->
                  ...
                  <div class="box-body">
					...
					<div class="form-group">
					 ...
					 <label>Test-Drive</label>
                      ...
                      <div class="radio" class="col-sm-14">
                        <label class="col-sm-3">
                          <input type="radio" name="t_d" value="Yes"onclick="Function()" data-toggle="modal" data-target="#myModal" value=""<?php if($row['Testdrive']=='Yes') { ?> checked="checked"<?php } ?> >
                          Yes
						</label>
						<label class="col-sm-6">
						  <input type="radio" name="t_d" value="No" onclick="func()" value=""<?php if($row['Testdrive']=='No') { ?> checked="checked"<?php } ?>>
                          No
                        </label>
                      </div>
                      </div>
            ...
            <div class="modal-footer">
              ...
              <div class="box box-success">
                ...
                <div class="box-body">
				    <div class="form-group">
                      <label>Address</label>
                      <textarea class="form-control input-sm" style="width:70%" rows="3" placeholder="Enter ..." name="res_add"><?php echo $row['Res_addr'];?></textarea>
                    </div>
					<div class="form-group">
                      <label>City</label>
				    ...
				    <div class="form-group">
                      <label for="phone">Phone</label>
                      <input type="text" style="width:70%" value="<?php echo $row['Res_phone'];?>" class="form-control input-sm" id="res-phone1" name="res_ph1"  placeholder="Enter mobile number">
                    </div>
					<div class="form-group">
                      <label for="phone">Alternate Phone</label>
                      <input type="text" style="width:70%" value="<?php echo $row['Res_phone2'];?>" class="form-control input-sm" id="res-phone2" name="res_ph2" placeholder="Enter mobile number">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Email</label>
                      <input type="text" style="width:70%" value="<?php echo $row['Email'];?>" class="form-control input-sm" id="exampleInputEmail1" name="res_em" placeholder="Enter mail">
                    </div>
					<div class="form-group">
                      <label for="phone">Pincode</label>
                      <input type="text" style="width:70%" value="<?php echo $row['Pincode'];?>" class="form-control input-sm" id="pin1" name="res_pin"  placeholder="Enter pincode">
                    </div>
					<div class="form-group">
			  ...
			  <div class="box box-warning">
                ...
                <div class="box-body">
                    <!-- text input -->
					 <div class="form-group">
                       <label>Model</label>
     		            <select class="form-control select2"  style="width:70%" name="rad" id="mySelect" >
