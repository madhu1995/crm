		...
		<form role="form" method="post">
		  <div class="box box-info"><input type="hidden" name="edi" value="<?php echo $_GET['edi']; ?>">
             ...
             <div class="box-body">
					...
					<div class="form-group">
                      <label for="enq">Customer_Id</label><input name="vcu" value="<?php echo $row['Cust_id'];?>" type="text" style="width:70%" class="form-control input-sm">
                    </div>
                    <div class="form-group">
                      <label for="mail">Customer_Name</label><input name="vcun" value="<?php echo $row['Cust_name'];?>" type="text" style="width:70%" class="form-control input-sm">
                    </div>
					
				    <div class="form-group">
                     <label>Model</label>
     		         <input type="text" id="model3" style="width:70%" disabled="" value="<?php echo $row['model'];?>" class="form-control input-sm">
                    </div>
			 <div class="form-group">
              <label>Fuel type</label>
     		    <select class="form-control" style="width:70%" name="fuel1">
			 ...
			 <div class="form-group">
              <label>Color</label>
     		    <select class="form-control" style="width:70%" name="col">
			...
			<div class="form-group">
              <label>Quantity</label>
     		    <select class="form-control" style="width:70%" name="quants">
			 ...
			 <div class="form-group">
              <label>Status</label>
     		    <select class="form-control" style="width:70%" name="sta">
					...
					<div class="form-group">
                      <label>Approx.date for booking</label>
			            <div class="input-group date" data-provide="datepicker" style="width:70%">
                          <input type="text" class="form-control" value="<?php echo $row['app_date'];?>" name="app" >
