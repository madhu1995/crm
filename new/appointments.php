...
{
$query=mysql_query("INSERT INTO ser_app (Customer_name,Customer_id,Car_No,Model,Fuel_Type,Engine_No,Service_No,Service,Service_Type,AMC_type,Kilometers_Covered,Warenty_period,Last_Service_Date,Due_Date, Service_Start_Date, Delivery_Date, Phone, Email, Address, City) VALUES ('".$_POST['cust_name']."','".$_POST['cust_id']."','".$_POST['car_no']."','".$_POST['model']."','".$_POST['fuel']."','".$_POST['eng_no']."','".$_POST['ser_no']."','".$_POST['ser']."','".$_POST['ser_typ']."', '".$_POST['amc']."', '".$_POST['kilomtr']."','".$_POST['wrnty']."', '".$_POST['ls_dt']."', '".$_POST['d_dt']."', '".$_POST['ser_dt']."', '".$_POST['del_dt']."', '".$_POST['phone']."', '".$_POST['mail']."', '".$_POST['add']."', '".$_POST['city']."')");
      ...
      <div class="content-wrapper">
		...
		<div class="box box-primary">
                 ...
                 <div class="box-header with-border">
                  <h3 class="box-title">Service_Details</h3>
		...
		<form role="form" method="post">
				  ...
				  <div class="col-xs-3">
                    <div class="form-group">
                      <label>Customer_Name</label><input type="text" style="width:70%" class="form-control input-sm" name="cust_name" placeholder="Enter name">
                    </div>
					
					<div class="form-group">
					 
                      <label for="phone">Customer_id</label>
                      <input type="text" style="width:70%" class="form-control input-sm" name="cust_id" placeholder="Enter service no">
                    </div>
					...
					<div class="form-group">
                      ...
                      <input type="text" style="width:70%" class="form-control input-sm" name="eng_no" placeholder="Enter">
                    </div>
                    ...
                    <div class="form-group">
                      <label>Service</label>
                      <select class="form-control" style="width:70%" name="ser">
					  <option value="" disabled selected>Select</option>
                      ...
                      <select class="form-control" style="width:70%" name="amc">
					  <option value="" disabled selected>Select</option>
                        <option>Gold</option>
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" style="width:70%" class="form-control input-sm" name="kilomtr" placeholder="Enter kilometer">
                    </div>		
                      ...
                      <input type="text" style="width:70%" class="form-control input-sm" name="wrnty" placeholder="Enter">
                    </div>
					
					  <div class="form-group">
                       <label>Last Service Date</label>
					    <div class="input-group date" data-provide="datepicker" style="width:70%" name="ls_dt">
					 ...
					 <div class="form-group">
                       <label>Due Date</label>
					    <div class="input-group date" data-provide="datepicker" style="width:70%" name="d_dt">
                        <input type="text" class="form-control" >
                      <div class="input-group-addon">
                        <span class="glyphicon glyphicon-th"></span>
                        </div>
                       ...
                       <label>Service start Date</label>
					    <div class="input-group date" data-provide="datepicker" style="width:70%" name"ser_dt">
                        <input type="text" class="form-control" >
                      <div class="input-group-addon">
                        <span class="glyphicon glyphicon-th"></span>
                        </div>
                       ...
                       <label>Delivery Date</label>
					    <div class="input-group date" data-provide="datepicker" style="width:70%" name="del_dt">
                        <input type="text" class="form-control" >
                      <div class="input-group-addon">
                       <span class="glyphicon glyphicon-th"></span>
                        </div>
				  ...
				  <div class="col-xs-3">
                    <div class="form-group">
                      ...
                      <input type="text" style="width:70%" class="form-control input-sm" name="phone" placeholder="Enter mobile number">
                    </div>
					<div class="form-group">
                      <label>Address</label>
                      <textarea class="form-control input-sm" style="width:70%" rows="3" name="add" placeholder="Address"></textarea>
                    </div>
                    
                  
				   <div class="form-group">
                      <label for="exampleInputEmail1">Email</label>
                      <input type="text" style="width:70%" class="form-control input-sm" name="mail" placeholder="Enter mail">
                    </div>
