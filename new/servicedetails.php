		          ...
		          <div class="col-xs-3">
		           <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <input type="text" style="width:70%" class="form-control input-sm" name="ser_by" placeholder="Name">
                    </div>
					
					<div class="form-group">
					  <label for="phone">Repairs</label>
                      <input type="text" style="width:70%" class="form-control input-sm" name="repair" placeholder="">
                    </div>
					  
					  <div class="form-group">
                      <label>Parts Replacement</label>
					  <select class="form-control" style="width:70%" name="parts" required>
					    <option value="" disabled selected>Select</option>
                        <option>Tire </option>
                        <option>Seat </option>
                        <option>radiator </option>
                        <option>mirror </option>
                        <option>hand brake </option>
					...
					<div class="col-xs-3">
					  ...
					  <div class="form-group">
                       <label>Delivery Date</label>
					    <div class="input-group date" data-provide="datepicker" style="width:70%" name="dl_dt">
                        <input type="text" class="form-control" >
                      <div class="input-group-addon">
                        <span class="glyphicon glyphicon-th"></span>
                        </div>
					  ...
					  <div class="form-group">
                       <label>Next Service Date</label>
					    <div class="input-group date" data-provide="datepicker" style="width:70%" name="nxt_dt">
                        <input type="text" class="form-control" >
                      <div class="input-group-addon">
                        <span class="glyphicon glyphicon-th"></span>
                        </div>
